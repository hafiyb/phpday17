                        ...
                        <tbody>
                            @isset($departments)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{url("/departmentedit/{$department->id}")}}">Edit  </a>
                                        <a href="{{url("/department/{$department->id}/2")}}">  Delete</a>
                                    </td>
                                </tr>
                                @endforeach
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Department count
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
